...
EXPECTED_API_EXPORTS = (
    ...
    "ToolAvailable", "WorldMismatchError", "all_of", "any_of", "observation", "llm_judge",
    "substantiated_by_tools", "no_divergence", "ScenarioPack", "evaluate_outcome",
    "evaluate_trajectory", "evaluate_constraint", "evaluate_robustness", "tool_name_matches",
    ...
    "StateResetConfig", "reset_state_db", "SynthesizeHook", "Universe", "UniverseFormatError",
    "UniverseMatching", "UniverseRecording", "UniverseTool", "freeze_universe", "load_universe",
    "save_universe", "InterchangeFormatError", "InterchangeMessage", "InterchangePart",
...
EXPECTED_DATACLASS_FIELDS = {
    Scenario: (
        ...
        "policies", "perturbations", "failure_cost", "variance_allowed", "tags",
    ),
    Trace: (
    ...
    Score: ("outcome", "trajectory", "constraint", "robustness", "failure_cost"),
    AgentConfig: (
