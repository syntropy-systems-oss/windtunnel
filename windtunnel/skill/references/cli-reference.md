<!-- GENERATED from docs/cli-reference.md at da97d123aca5 — do not edit; edit docs/cli-reference.md. -->
---
...
| `--json` | no | false | Print one JSON document instead of per-trace lines: per trace, the old (sidecar) and new verdict and detail of every layer, the headline verdict, old and new metrics, and a summary. |
